...
public class Silly implements Comparable<Silly>{
    ...
    /**
     * Creates a new Silly object.
     * This constructer takes in two strings as an argument and names the
     * object as the concatenation of both strings.
     *
     * @param first_string the first name
     * @param second_string the second name
     */
